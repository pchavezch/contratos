...
class AdhesionWidget extends StatefulWidget {
  final ResultLogin resultLogin;
  const AdhesionWidget(this.resultLogin, {Key? key}) : super(key: key);

  @override
  _AdhesionWidgetState createState() => _AdhesionWidgetState(resultLogin);
}

class _AdhesionWidgetState extends State<AdhesionWidget> {
  final ResultLogin resultLogin;
  ...
  Future<List<Option>> _doLoadDataValuesFormat() async {
    ...
    print("to navigate:" + ConnectionPath().restApiGetValues);
  ...
  _AdhesionWidgetState(this.resultLogin);
  @override
  void initState() {
    super.initState();
    //_currentDataValuesFormat = [];
