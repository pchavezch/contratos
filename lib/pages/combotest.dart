...
class Repository {
  ...
  List getAll() => getValuesFromNetwork();
  ...
  Future<List<String>> getLocalByState(String state) async {
    ...
    return Future.value(getValuesFromNetwork()
        .map((map) => StateModel.fromJson(map))
        .where((item) => item.state == state)
        .map((item) => item.lgas)
        .expand((i) => i)
  ...
  List<String> getStates() => getValuesFromNetwork()
      .map((map) => StateModel.fromJson(map))
      .map((item) => item.state)
      .toList();
  // _nigeria.map((item) => item['state'].toString()).toList();

  List _paises = getValuesFromNetwork();
  List _nigeria = [
    {
      "state": "Adamawa",
      "alias": "adamawa",
  ...
  static List getValuesFromNetwork() {
    return [
      {
        "state": "Abia",
        "alias": "abia",
